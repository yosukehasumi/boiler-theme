  ...
  <article class="docs-component" id="docs-kitchen-sink">
    ...
    <div class="row">
      ...
      <div class="large-9 columns" id="docs">
        ...
        <div class="docs-code-live"><form data-abide="zk1mik-abide" novalidate="" lpformnum="1">
          ...
          <div class="row">
            ...
            <div class="small-12 columns">
              <label>Re-enter Password
                <input type="password" placeholder="yeti4preZ" aria-describedby="exampleHelpText2" required="" pattern="alpha_numeric" data-equalto="password" style="background-image: url(&quot;data:image/png;base64,&quot;); background-repeat: no-repeat; background-attachment: scroll; background-size: 16px 18px; background-position: 98% 50%;">
                <span class="form-error">
                  Hey, passwords are supposed to match!
                </span>
              </label>
        ...
        <div class="docs-code-live"><ul class="accordion" data-accordion="kpk1km-accordion" role="tablist">
          <li class="accordion-item is-active">
            <!-- The tab title needs role="tab", an href, a unique ID, and aria-controls. -->
            <a href="#panel1d" role="tab" class="accordion-title" id="panel1d-heading" aria-controls="panel1d" aria-expanded="true" aria-selected="true">Accordion 1</a>
            <!-- The content pane needs an ID that matches the above href, role="tabpanel", data-tab-content, and aria-labelledby. -->
            <div id="panel1d" class="accordion-content" role="tabpanel" data-tab-content="" aria-labelledby="panel1d-heading" aria-hidden="false" style="display: block;">
              Panel 1. Lorem ipsum dolor
            </div>
          </li>
        ...
        <div class="docs-code-live"><ul class="vertical menu" data-accordion-menu="kumlq8-accordion-menu" role="menu" aria-multiselectable="true">
          <li role="menuitem" class="is-accordion-submenu-parent" aria-haspopup="true" aria-label="Item 1" aria-controls="y70vs5-acc-menu" aria-expanded="true" id="s8bl1d-acc-menu-link">
            <a href="#0">Item 1</a>
            <ul class="menu vertical nested is-active submenu is-accordion-submenu" data-submenu="" role="menu" aria-labelledby="s8bl1d-acc-menu-link" aria-hidden="false" id="y70vs5-acc-menu" style="">
              <li role="menuitem" class="is-accordion-submenu-parent is-submenu-item is-accordion-submenu-item" aria-haspopup="true" aria-label="Item 1A" aria-controls="or7azc-acc-menu" aria-expanded="false" id="715v8t-acc-menu-link">
                <a href="#0">Item 1A</a>
                <ul class="menu vertical nested submenu is-accordion-submenu" data-submenu="" role="menu" aria-labelledby="715v8t-acc-menu-link" aria-hidden="true" id="or7azc-acc-menu" style="display: none;">
          ...
          <li role="menuitem" class="is-accordion-submenu-parent" aria-haspopup="true" aria-label="Item 2" aria-controls="7hooho-acc-menu" aria-expanded="false" id="g545f4-acc-menu-link">
            <a href="#0">Item 2</a>
            <ul class="menu vertical nested submenu is-accordion-submenu" data-submenu="" role="menu" aria-labelledby="g545f4-acc-menu-link" aria-hidden="true" id="7hooho-acc-menu" style="display: none;">
        ...
        <div class="docs-code-live"><span class="secondary badge">2</span>
          ...
          <div class="docs-code-live"><!-- Anchors (links) -->
            ...
            <div class="docs-code-live"><div class="is-drilldown" style="min-height: 230.25px; max-width: 200px;"><ul class="vertical menu" data-drilldown="cn83ht-drilldown" style="width: 200px" id="m1" role="menubar" data-mutate="zj6dx0-drilldown">
              <li role="menuitem" class="is-drilldown-submenu-parent" aria-haspopup="true" aria-label="Item 1" aria-expanded="false">
                <a tabindex="0">Item 1</a>
                <ul class="vertical menu submenu is-drilldown-submenu drilldown-submenu-cover-previous" id="m2" data-submenu="" role="menu" aria-hidden="true"><li class="js-drilldown-back"><a tabindex="0">Back</a></li>
                  <li role="menuitem" class="is-drilldown-submenu-parent is-submenu-item is-drilldown-submenu-item" aria-haspopup="true" aria-label="Item 1A" aria-expanded="false">
                    <a tabindex="0">Item 1A</a>
                    <ul class="vertical menu submenu is-drilldown-submenu drilldown-submenu-cover-previous" id="m3" data-submenu="" role="menu" aria-hidden="true"><li class="js-drilldown-back"><a tabindex="0">Back</a></li>
              ...
              <li role="menuitem" class="is-drilldown-submenu-parent" aria-haspopup="true" aria-label="Item 2" aria-expanded="false">
                <a tabindex="0">Item 2</a>
                <ul class="vertical menu submenu is-drilldown-submenu drilldown-submenu-cover-previous" data-submenu="" role="menu" aria-hidden="true"><li class="js-drilldown-back"><a tabindex="0">Back</a></li>
              ...
              <li role="menuitem" class="is-drilldown-submenu-parent" aria-haspopup="true" aria-label="Item 3" aria-expanded="false">
            ...
            <div class="docs-code-live"><ul class="dropdown menu" data-dropdown-menu="9q1moz-dropdown-menu" role="menubar">
            ...
            <div class="docs-code-live"><button class="button" type="button" data-toggle="example-dropdown" aria-controls="example-dropdown" data-is-focus="false" data-yeti-box="example-dropdown" aria-haspopup="true" aria-expanded="false">Toggle Dropdown</button>
              <div class="dropdown-pane" id="example-dropdown" data-dropdown="deqmqx-dropdown" aria-hidden="true" data-yeti-box="example-dropdown" data-resize="example-dropdown" aria-labelledby="s3p8ny-dd-anchor">
                Just some junk that needs to be said. Or not. Your choice.
              </div></div><hr>
              ...
              <div class="docs-code-live"><div class="row" data-equalizer="q67r60-equalizer" data-equalize-on="medium" id="test-eq" data-resize="lht9re-eq" data-mutate="tcvzh8-eq" data-events="mutate">
                <div class="medium-4 columns">
                  <div class="callout" data-equalizer-watch="" style="height: 270px;">
            ...
            <hr>
            <h2 id="responsive-embed" class="docs-heading" data-magellan-target="responsive-embed">Responsive Embed<a class="docs-heading-icon" href="#responsive-embed"></a></h2><a class="docs-code-toggle">Toggle Code</a><div class="docs-code kitchen-sink" data-docs-code="" style="display: none;"><button class="docs-code-copy" id="copy-btn-13">Copy</button><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"responsive-embed"</span>&gt;</span>
            ...
            <div class="docs-code-live"><form lpformnum="2">
              <label>Input Label
          ...
          <div class="docs-code-live"><img data-interchange="[assets/img/interchange/small.jpg, small], [assets/img/interchange/medium.jpg, medium], [assets/img/interchange/large.jpg, large]" src="assets/img/interchange/large.jpg"></div><hr>
          ...
          <div class="docs-code-live"><span class="secondary label">Secondary Label</span>
            ...
            <span class="hljs-tag">&lt;/<span class="hljs-name">section</span>&gt;</span>
            <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre></div><ul class="horizontal menu" data-magellan="g07fl3-magellan" data-resize="q04529-magellan" data-scroll="q04529-magellan" id="q04529-magellan">
          ...
          <div class="docs-code-live"><div class="orbit" role="region" aria-label="Favorite Space Pictures" data-orbit="7z3fcl-orbit" data-resize="wn07es-orbit" id="wn07es-orbit">
            <ul class="orbit-container" tabindex="0" style="height: 160px;">
              ...
              <li class="orbit-slide is-active" data-slide="0" aria-live="polite" style="display: block; position: relative; top: 0px;">
                <div>
              ...
              <li class="orbit-slide" data-slide="3" style="position: relative; top: 0px; display: none;">
                <div>
                  <h3 class="text-center">You can also throw some text in here!</h3>
                  <p class="text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Unde harum rem, beatae ipsa consectetur quisquam. Rerum ratione, delectus atque tempore sed, suscipit ullam, beatae distinctio cupiditate ipsam eligendi tempora expedita.</p>
                  <h3 class="text-center">This Orbit slide has chill</h3>
        ...
        <div class="top-bar" id="example-menu">
          <div class="top-bar-left">
            <ul class="dropdown menu" data-dropdown-menu="edvstn-dropdown-menu" role="menubar">
        ...
        <div class="docs-code-live"><div class="slider" data-slider="bggg4j-slider" data-initial-start="50" data-end="200">
          <span class="slider-handle" data-slider-handle="" role="slider" tabindex="0" aria-controls="cwcalc-slider" aria-valuemax="200" aria-valuemin="0" aria-valuenow="50" aria-orientation="horizontal" style="left: 24.36%;"></span>
          <span class="slider-fill" data-slider-fill="" style="width: 25%;"></span>
          <input type="hidden" id="cwcalc-slider" max="200" min="0" step="1" value="50">
        </div>

        <div class="slider vertical" data-slider="g2l29b-slider" data-initial-start="25" data-end="200" data-vertical="true">
          <span class="slider-handle" data-slider-handle="" role="slider" tabindex="0" aria-controls="e6gvgb-slider" aria-valuemax="200" aria-valuemin="0" aria-valuenow="25" aria-orientation="vertical" style="top: 11.54%;"></span>
          <span class="slider-fill" data-slider-fill="" style="height: 13%;"></span>
          <input type="hidden" id="e6gvgb-slider" max="200" min="0" step="1" value="25">
        </div>

        <div class="slider" data-slider="rtn4k0-slider" data-initial-start="25" data-initial-end="75">
          <span class="slider-handle" data-slider-handle="" role="slider" tabindex="0" aria-controls="5a6b5h-slider" aria-valuemax="100" aria-valuemin="0" aria-valuenow="25" aria-orientation="horizontal" style="left: 24.36%;"></span>
          <span class="slider-fill" data-slider-fill="" style="width: 0px; min-width: 50.07%; left: 24.36%;"></span>
          <span class="slider-handle" data-slider-handle="" role="slider" tabindex="0" aria-controls="2i0uo0-slider" aria-valuemax="100" aria-valuemin="0" aria-valuenow="75" aria-orientation="horizontal" style="left: 73.07%;"></span>
          <input type="hidden" id="5a6b5h-slider" max="100" min="0" step="1" value="25">
          <input type="hidden" id="2i0uo0-slider" max="100" min="0" step="1" value="75">
        </div></div><hr>
        ...
        <div class="docs-code-live"><div class="row">
          <div class="columns small-12">
            ...
            <div class="columns small-6 right sticky-container" data-sticky-container="" style="height: 230.641px;">
              <div class="sticky is-anchored is-at-top" data-sticky="5bm3ta-sticky" data-anchor="example1" data-resize="j7std2-sticky" style="max-width: 405px; margin-top: 0px; bottom: auto; top: 0px;">
        ...
        <div class="docs-code-live"><ul class="tabs" data-tabs="oy6r6b-tabs" id="example-tabs" role="tablist">
        ...
        <div class="docs-code-live"><p><a data-toggle="menuBar" aria-controls="menuBar">Expand!</a></p>
          ...
          <div class="docs-code-live"><p>The <span data-tooltip="xhoudp-tooltip" aria-haspopup="true" class="has-tip" data-disable-hover="false" tabindex="1" title="" aria-describedby="tbthup-tooltip" data-yeti-box="tbthup-tooltip" data-toggle="tbthup-tooltip" data-resize="tbthup-tooltip">scarabaeus</span> hung quite clear of any branches, and, if allowed to fall, would have fallen at our feet. Legrand immediately took the scythe, and cleared with it a circular space, three or four yards in diameter, just beneath the insect, and, having accomplished this, ordered Jupiter to let go the string and come down from the tree.</p></div><hr>
          ...
          <div class="docs-code-live"><div class="top-bar">
            <div class="top-bar-left">
              <ul class="dropdown menu" data-dropdown-menu="rqf2xw-dropdown-menu" role="menubar">
                <li class="menu-text" role="menuitem">Site Title</li>
                <li class="has-submenu is-dropdown-submenu-parent opens-right" role="menuitem" aria-haspopup="true" aria-label="One">
                  <a href="#0">One</a>
                  <ul class="submenu menu vertical is-dropdown-submenu first-sub" data-submenu="" role="menu">
          ...
          <div class="large-3 columns sticky-container" data-sticky-container="">
            <nav class="columns docs-toc-wrap sticky is-anchored is-at-top" data-sticky="oyc0h7-sticky" data-anchor="docs" data-sticky-on="large" data-resize="1fleqa-sticky" style="max-width: 270px; margin-top: 0px; bottom: auto; top: 0px;">
              <div class="docs-toc hide" id="docsTOC">
                <ul class="vertical menu" data-docs-toc="" data-resize="eadgo1-magellan" data-scroll="eadgo1-magellan" id="eadgo1-magellan" data-magellan="kgjlol-magellan">
                  <li class="docs-nav-title">On this page:</li>
                  <li><a href="#abide">Abide</a></li><li><a href="#accordion">Accordion</a></li><li><a href="#accordion-menu">Accordion Menu</a></li><li><a href="#badge">Badge</a></li><li><a href="#breadcrumbs">Breadcrumbs</a></li><li><a href="#button">Button</a></li><li><a href="#callout">Callout</a></li><li><a href="#close-button">Close Button</a></li><li><a href="#drilldown-menu">Drilldown Menu</a></li><li><a href="#dropdown-menu">Dropdown Menu</a></li><li><a href="#dropdown-pane">Dropdown Pane</a></li><li><a href="#equalizer">Equalizer</a></li><li><a href="#flex-grid">Flex Grid</a></li><li><a href="#responsive-embed">Responsive Embed</a></li><li><a href="#float-classes">Float Classes</a></li><li><a href="#forms">Forms</a></li><li><a href="#grid">Grid</a></li><li><a href="#interchange">Interchange</a></li><li><a href="#label">Label</a></li><li><a href="#magellan">Magellan</a></li><li><a href="#media-object">Media Object</a></li><li><a href="#menu">Menu</a></li><li><a href="#off-canvas">Off-canvas</a></li><li><a href="#orbit">Orbit</a></li><li><a href="#pagination">Pagination</a></li><li><a href="#progress-bar">Progress Bar</a></li><li><a href="#responsive-menu">Responsive Menu</a></li><li><a href="#responsive-toggle">Responsive Toggle</a></li><li><a href="#reveal">Reveal</a></li><li><a href="#slider">Slider</a></li><li><a href="#sticky">Sticky</a></li><li><a href="#switch">Switch</a></li><li><a href="#table">Table</a></li><li><a href="#tabs">Tabs</a></li><li><a href="#thumbnail">Thumbnail</a></li><li><a href="#title-bar">Title Bar</a></li><li><a href="#toggler">Toggler</a></li><li><a href="#tooltip">Tooltip</a></li><li><a href="#top-bar">Top Bar</a></li><li><a href="#visibility-classes">Visibility Classes</a></li></ul>
                </div>
                <div class="foundation-toc-ad-unit" id="TOCAdUnit"><div class="ad-unit" ouf7cpu="" hidden=""><h3 class="ad-unit-title">Master Kitchen Sink</h3><p class="ad-unit-text">Get up to speed FAST, learn straight from the experts who built Foundation.</p><a class="button ad-unit-button" href="http://zurb.com/university/foundation-intro?utm_source=Foundation%20Docs&amp;utm_medium=Docs&amp;utm_content=Struggling&amp;utm_campaign=Docs%20To%20Intro">Learn More</a></div></div>
              </nav>
            </div>
